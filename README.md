...
A trilha de P&D para a plataforma quant cripto está em [docs/2026-08-31-roadmap-pesquisa-quant-cripto.md](docs/2026-08-31-roadmap-pesquisa-quant-cripto.md). O plano em fases do pipeline de volatilidade está em [docs/2026-09-02-plano-pipeline-vol.md](docs/2026-09-02-plano-pipeline-vol.md); a Fase 1 (carry delta-hedgeado) está executada em [docs/2026-09-02-carry-delta-hedgeado.md](docs/2026-09-02-carry-delta-hedgeado.md) (`scripts/run_delta_hedged_carry.py`) a Fase 2 (custo de execução) em [docs/2026-09-02-custo-execucao.md](docs/2026-09-02-custo-execucao.md) (`scripts/run_execution_cost_scenarios.py`) a Fase 3 (sizing, margem e ruína) em [docs/2026-09-02-sizing-margem-ruina.md](docs/2026-09-02-sizing-margem-ruina.md) (`scripts/run_hedged_book_sizing.py`) e o [bootstrap condicionado a regime](docs/2026-09-02-bootstrap-condicionado.md), que validou o lado short do gate (`scripts/run_conditioned_bootstrap.py`). O [book rolling sintético](docs/2026-09-02-book-rolling-sintetico.md) executa decisões diárias e risco agregado; o [coletor do tape histórico](docs/2026-09-02-tape-trades-deribit.md) prepara a substituição da entrada sintética por prints reais.
