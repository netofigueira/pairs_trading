...
<h1>Quant Data Health</h1><p class="muted">Cobertura de candles fechados no TimescaleDB.</p><table><thead><tr><th>Ativo</th><th>Intervalo</th><th>Barras</th><th>Primeira</th><th>Última</th><th>Atraso</th></tr></thead><tbody id="rows"></tbody></table>
